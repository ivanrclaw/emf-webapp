...
export class OCLHoverEngine {
     ...
     */
    hover(expression, cursorOffset, contextClassName) {
    ...
    hoverIdentifier(expression, word, range, cursorOffset, contextClassName) {
    ...
    makeOperationHover(word, range, op, receiverType) {
    ...
    inferType(expr, contextClassName) {
        try {
...
//# sourceMappingURL=OCLHoverEngine.js.map