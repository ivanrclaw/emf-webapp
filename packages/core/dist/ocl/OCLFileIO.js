...
const CONSTRAINT_KINDS = ['inv', 'pre', 'post', 'def', 'init', 'derive', 'body'];
...
export function importOCLFile(content) {
...
export function exportOCLFile(constraints, options) {
...
//# sourceMappingURL=OCLFileIO.js.map