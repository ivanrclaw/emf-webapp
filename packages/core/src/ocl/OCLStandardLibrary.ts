...
export function resolveReturnType(
  ...
  if (returnType === 'self') return selfType;
  if (returnType === 'boolean') return OCL.Boolean;
...
export const OclAnyOperations: OCLOperationSignature[] = [
...
export const BooleanOperations: OCLOperationSignature[] = [
...
export const IntegerOperations: OCLOperationSignature[] = [
...
export const RealOperations: OCLOperationSignature[] = [
...
export const StringOperations: OCLOperationSignature[] = [
  // Query
...
export const CollectionOperations: OCLOperationSignature[] = [
  // Membership & Counting
...
export const CollectionIteratorOperations: OCLOperationSignature[] = [
...
export const OrderedCollectionOperations: OCLOperationSignature[] = [
...
export const SequenceOperations: OCLOperationSignature[] = [
...
export const OrderedSetOperations: OCLOperationSignature[] = [
...
export const SetOperations: OCLOperationSignature[] = [
 ...
 */
export function getOperationsForType(type: OCLType): OCLOperationSignature[] {
  const ops: OCLOperationSignature[] = [...OclAnyOperations];
...
function getOperationsForPrimitive(name: PrimitiveTypeName): OCLOperationSignature[] {
  switch (name) {
    case 'Boolean':
...
function isOrderedCollection(kind: CollectionKind): boolean {
