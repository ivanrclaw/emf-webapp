    ...
    if ((feature as any).eReferenceType != null) {
      ...
      if (attr.many) {
        ...
        if (value != null && value !== undefined) {
          ...
          if (feature.name === 'lowerBound' && strValue === '0') continue;
          if (feature.name === 'upperBound' && strValue === '1') continue;
          if (feature.name === 'iD' && strValue === 'false') continue;
          if (feature.name === 'changeable' && strValue === 'true') continue;
          if (feature.name === 'derived' && strValue === 'false') continue;
          if (feature.name === 'transient' && strValue === 'false') continue;
          if (feature.name === 'defaultValueLiteral' && strValue === '') continue;
          if (feature.name === 'serializable' && strValue === 'true') continue;
          if (feature.name === 'containment' && strValue === 'false') continue;
          if (feature.name === 'value' && strValue === '0') continue;
